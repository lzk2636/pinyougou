    ...
    public Map WxNative(String out_trade_no, String total_fee){
        ...
        try {
          ...
          //  System.out.println(result);
            ...
            String path="https://qr.api.cli.im/qr?data=wxp%3A%2F%2Ff2f0Dm6OWDOplR8oOQPin1_FZJe1J7IPAOk4&level=H&transparent=false&bgcolor=%23ffffff&forecolor=%23000000&blockpixel=12&marginblock=1&logourl=&size=260&kid=cliim&key=082f0d41ee3d9b3ff6b20e36da50eb2c";
            map.put("code_url", path);//支付地址
            map.put("total_fee", total_fee);//总金额
            map.put("out_trade_no",out_trade_no);//订单号
            System.out.println(map.get("out_trade_no")+"ssss");
            return map;
        } catch (Exception e) {
            e.printStackTrace();
            return new HashMap<>();
