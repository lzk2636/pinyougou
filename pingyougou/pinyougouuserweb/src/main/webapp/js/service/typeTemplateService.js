...
app.service('typeTemplateService',function($http){
	...
	this.simpleExample=function () {
		return $http.get('../typeTemplate/simpleExample.do')
	}
	this.findMapOptions=function (id) {
		return $http.get('../typeTemplate/findMapOptions.do?id='+id)
	}
});
