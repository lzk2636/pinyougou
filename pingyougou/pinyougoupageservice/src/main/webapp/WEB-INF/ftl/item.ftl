...
<head>
	...
	<script type="text/javascript" src="js/controller/itemsController.js">  </script>
	<script>
...
<body ng-app="myapp" ng-controller="itemsController" ng-init="initData()">
...
<!--页面顶部 结束-->
	<div class="py-container">
		<div id="item">
			...
			<#assign imageItem=goodsDesc.itemImages?eval>
			<!--product-info-->
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imageItem?size>0)>
								<img jqimg="${imageItem[0].url}" src="${imageItem[0].url}" width="400px" height="400px" />
								</#if>
							</span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									<#list imageItem as lists>
										<li><img src="${lists.url}" bimg="${lists.url}" onmousemove="preview(this)" /></li>
									</#list>
						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationItems as item>
								...
								<#list item.attributeValue as value>
									<dd><a href="javascript:;" ng-click="checkedCode('${item.attributeName}','${value}')"  class="{{isCheck('${item.attributeName}','${value}')?'selected':''}}">${value}
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a  ng-click="shoppingId()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
